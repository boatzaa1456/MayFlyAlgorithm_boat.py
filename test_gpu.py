...
def mayfly(name_path_input, num_gen, pop_size, *parameters):
    ...
    # Original parallel processing section removed
    # Process male and female populations directly without parallel execution
    male_results = process_mayfly_population(male_mayfly_population)
    female_results = process_mayfly_population(female_mayfly_population)

    gbest_each_gen = []
    male_each_gen = []
    female_each_gen = []

    # Unpack the results for both male and female populations
        ...
        for sol in range(half_pop_size):
            ...
            if male_current_value <= male_pbest_value[sol]:
                ...
                if male_pbest_value[sol] <= gbest_value:
                    ...
                    mnew_pos = nuptial_dance(male_cur_sols[sol][:], gbest_sol)
