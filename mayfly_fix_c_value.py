...
def mayfly(name_path_input, num_gen, pop_size, *parameters):
    ...
    #---------------------- ส่วนของ Mayfly ตัวผู้ ----------------------
        ...
        for sol in range(half_pop_size):
            ...
            male_coef_velocity = coef_times_velocity(gravity_calculation(0.9,0.4,gen,num_gen), male_velocity_dict[sol])
    ...
    # ---------------------- ส่วนของ Mayfly ตัวเมีย ---------------------- #
        ...
        for sol in range(half_pop_size):
            # ทำการคำนวณแต่ละขั้นตอนและรวมผลลัพธ์ในขั้นตอนเดียว
            female_coef_velocity = coef_times_velocity(gravity_calculation(0.9,0.4,gen,num_gen), female_velocity_dict[sol])
