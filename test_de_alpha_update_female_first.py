    ...
    for gen in range(num_gen):
        ...
        for sol in range(half_pop_size):
            ...
            if not better_than_gbest:
                ...
                fcut_set = creat_cut_set(fvelocity_check_incon, alpha_calculation(gen, num_gen))
            ...
            if not better_than_gbest:
                ...
                mcut_set = creat_cut_set(mvelocity_check_incon,alpha_calculation(gen, num_gen))
...
gbest_each_gen, male_each_gen, female_each_gen = mayfly(name_path_input, num_gen, pop_size, a1, a2, a3, gmax, gmin,alpha,seed)
...
plt.ylabel('Values')
plt.title(
    f'{name_path_input} - {pop_size} Population Size - {num_gen} Generations - Seed {seed} - Tadiness: {gbest_value}')
