...
def mayfly(name_path_input, num_gen, pop_size, *parameters):
    ...
    print(f"cutset was used {count_cutset_used} times")
    print(f"previousx was used {count_previous_x_used} times")
    print(f"sub_e was used {count_sub_E_list_used} times")
    print("----" * 50)
...
name_path_input = '1R-20I-150C-4P'
df_item_pool = read_input(name_path_input)
gbest_each_gen, male_each_gen, female_each_gen = mayfly(name_path_input, num_gen, pop_size, a1, a2, a3, g,alpha, random_seed)
...
#         mayfly(name_path_input, ng, ps, a1[0], a2[0], a3[0], gmax[0], gmin[0], alpha[0],seeds[0])
#         end_time = time.time()
...
# headers = ['a1', 'a2', 'a3', 'alpha', 'gmax', 'gmin', 'num_pop', 'gbest_per_gen', 'replication', 'seed', 'time', 'count_cutset_used', 'count_previous_x_used', 'count_sub_E_list_used']
# results = []
#
...
#                                     gbest_each_gen = mayfly(name_path_input, ng, ps, x, y, z, gm, gmi, a, my_seed)
#                                     end_time = time.time()  # End timing
#                                     duration = end_time - start_time  # Calculate duration
#                                     current_num_pop = (ng, ps)
#                                     results.append([x, y, z, a, gm, gmi, current_num_pop, gbest_each_gen, rep, my_seed, duration, count_cutset_used, count_previous_x_used, count_sub_E_list_used]) # Include duration in results
#                                     pbar.update(1)
#
